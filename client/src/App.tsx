...
import RevenuePlan from "./pages/RevenuePlan";
...
import ShipmentReceipts from "./pages/ShipmentReceipts";
import OnecImportRegistry from "./pages/OnecImportRegistry";
...
import EvotorReceipts from "./pages/EvotorReceipts";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/revenue-plan" component={RevenuePlan} />
      ...
      <Route path="/shipment-receipts" component={ShipmentReceipts} />
      <Route path="/onec-import" component={OnecImportRegistry} />
      ...
      <Route path="/evotor-sales/receipts" component={EvotorReceipts} />
...
const sellerPaths = new Set(["/revenue", "/revenue-plan", "/stock-control", "/shipment-receipts", "/inventory-control", "/requests", "/notifications", "/profile"]);
const managerPaths = new Set(["/revenue-plan", "/stock-control", "/stock-transfers", "/shipment-receipts", "/inventory-control", "/requests", "/notifications", "/profile"]);
