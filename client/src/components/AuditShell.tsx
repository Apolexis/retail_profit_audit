...
const navSections=[
  ...
  {title:"УПРАВЛЕНИЕ",items:[["/notifications","17","Сигналы",false],["/reports","18","Отчеты",true],["/import","12","Импорт",true],["/manage","13","База",true],["/access","15","Доступ",true],["/history","16","Журнал",true],["/erp-roadmap","20","ERP-дорожная карта",false]]},
] as const;
...
recommendations["20"]={title:"ERP: сначала согласуйте источник",text:"Дорожная карта описывает безопасное подключение продаж, остатков, сроков и заявок без подмены финансовых фактов.",action:"Начните с технической документации ERP и тестовой выгрузки без персональных данных."};
