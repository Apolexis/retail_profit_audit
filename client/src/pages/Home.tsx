...
export default function Home() {
  ...
  return <AuditShell kicker="00 / СЕТЕВОЙ ОБЗОР" title="Операционный пакет сети">
    {facts.loading ? <FactsLoader/> : !facts.available ? <EmptyFacts/> : <>
