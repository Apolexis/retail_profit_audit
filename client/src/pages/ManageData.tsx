...
export default function ManageData() {
  ...
  const selectMetric = (metricCode: string, value: string) => { setEditingCode(metricCode); setEditingEntryDate(resolvedEntryDate); setCode(metricCode); setNextMetricCode(metricCode); setAmount(value); setMessage(""); };
