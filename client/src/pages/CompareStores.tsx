...
type SummaryMetric = "revenue" | "grossProfit" | "netProfit" | "expenses" | "purchases" | "purchaseSmoked" | "purchaseFrozen" | "salesSmoked" | "salesFrozen" | "stockOpen" | "stockClose" | "stockChange" | "writeoffSmoked" | "writeoffFrozen" | "netMargin" | "grossMargin" | "markup" | "coverDays";
...
const metricGroups: Array<{ label: string; metrics: ComparisonMetric[] }> = [
  ...
  { label: "Маржинальность", metrics: ["grossMargin", "netMargin", "markup"] },
