...
export default function Expenses() {
  ...
  const storeComparisonTrend = useMemo(() => {
    if (!showStoreSeries || !networkSelected || selectedFields.length !== 1) return null;
  ...
  }, [aggregateTrend, facts.rowsFor, facts.storeNames, networkSelected, selectedFields, showStoreSeries]);
