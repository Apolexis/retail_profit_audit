...
export default function Profile() {
  ...
  const enablePasskey = async () => {
    try {
      ...
      const message = error instanceof Error ? error.message : "Не удалось добавить ключ доступа";
      if (message !== "The operation either timed out or was not allowed.") toast.error(message);
    }
  };
