export type CadenceMetric =
  ...
  | "evotorAmount" | "evotorChecks" | "evotorAverage";
...
const valuesFor = (metrics: Record<string, unknown>): CadenceValues => ({
  ...
  evotorAmount: 0, evotorChecks: 0, evotorAverage: 0,
});

const cadenceKeys: CadenceMetric[] = ["revenue", "cashRevenue", "cashlessRevenue", "receiptsTotal", "grossProfit", "netProfit", "purchases", "purchaseSmoked", "purchaseFrozen", "salesSmoked", "salesFrozen", "expenses", "cashExpenses", "cashlessExpenses", "cashTaxes", "household", "delivery", "cleaning", "bonus", "seniority", "supplement", "driverCash", "utilitiesCash", "operatingCosts", "cashlessOperatingCosts", "driverCashless", "utilitiesCashless", "rent", "bankFee", "grossProfitTax", "salaryCashless", "payrollTax", "vacationCashless", "vacationTax", "salaryCash", "vacationCash", "writeoffSmoked", "writeoffFrozen", "movement", "discount", "evotorAmount", "evotorChecks", "evotorAverage"];
