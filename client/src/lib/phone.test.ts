...
describe("российский телефон",()=>{
  ...
  it("удаляет цифру, а не застревает на скобке или дефисе",()=>{const value="79537573636";const shown=formatRussianPhone(value);expect(removePhoneDigitAtCursor(value,shown,8,8,"backspace")).toBe("7953573636");expect(removePhoneDigitAtCursor(value,shown,12,12,"delete")).toBe("7953753636");});
});
