...
stores = [{
    ...
    'inventoryEffect': rnd(x['inventory_net_effect']/1_000_000), 'narrative': x['narrative']
...
text += 'export const auditChecks = [["Исходных листов-магазинов", "43"], ["Включено в срез", "33"], ["P&L-блоков", "264"], ["Формульных ячеек", "310 723"], ["Расхождений > 0,15 руб.", "0"]] as const;\n'
