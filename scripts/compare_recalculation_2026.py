...
RECALCULATED = Path("/home/ubuntu/retail_profit_audit_2026/audit_2026/audit_august_clean/recalculated/2026.xlsx")
...
def main():
    source_formulas = load_workbook(SOURCE, data_only=False)
    source_values = load_workbook(SOURCE, data_only=True)
