...
function normalizeCommitOptions(value: unknown): ImportCommitOptions {
  ...
  if (categorySelections.length > 3000 || priceEdits.length > 36_000 || excludedRowIndexes.length > 3000) {
