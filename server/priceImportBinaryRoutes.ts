...
function normalizeCommitOptions(value: unknown): ImportCommitOptions {
  ...
  if (categorySelections.length > 3000 || priceEdits.length > 36_000 || rowEdits.length > 3000 || metadataEdits.length > 3000 || productLinks.length > 3000 || excludedRowIndexes.length > 3000) {
